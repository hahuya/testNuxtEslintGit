module.exports = {
  ...
  rules: {
    ...
    'no-duplicate-case': 2, // case子句中有重复的测试表达式
    ...
    'no-inner-declarations': [1, 'functions'], // 禁止在嵌套的块中出现变量声明或 function 声明
    ...
    'no-global-assign': 0, // 禁止对原生对象或只读的全局对象进行赋值，原no-native-reassign已被此替换
